...
package com.wonders.ic.contractPlan.dao.impl;
...
public class ContractPlanDaoImpl extends AbstractHibernateDaoImpl<ContractPlan> implements ContractPlanDao {
	public Page findContractPlanByPage(Map<String, Object> filter, int pageNo,
			int pageSize) {
		if (filter == null)
			filter = new HashMap<String, Object>();
		List<HqlParameter> args = new ArrayList<HqlParameter>();
		String hql = "select t from ContractPlan t ";
		String countHql = "select count(*) from ContractPlan t ";
		String filterPart = "";
		int filterCounter = 0;
		if (!filter.isEmpty()) {
			filterPart += " where ";
			for (Iterator<String> i = filter.keySet().iterator(); i.hasNext();) {
				...
				if(paramName.equals("contractNo")){
		...
		filterPart += " order by t.updateDate DESC";
