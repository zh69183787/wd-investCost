...
insert into CP_MENU_RESOURCE (ID, CODE, RESOURCE_NAME, VALID, DESCRIPTION, LINKPATH, DISP_ORDER, BIG_IMAGE, PARENT_RESOURCE_ID, ICON)values (1032, '20010100', '授予权限', 1, null, 'security.userAuthList'||chr(38)||'state=1', 0, null, 1010,  '../images/nav_icon/auth/auth.gif');
insert into CP_MENU_RESOURCE (ID, CODE, RESOURCE_NAME, VALID, DESCRIPTION, LINKPATH, DISP_ORDER, BIG_IMAGE, PARENT_RESOURCE_ID, ICON)values (1033, '20010200', '禁止权限', 1, null, 'security.userAuthList'||chr(38)||'state=2', 1, null, 1010,  '../images/nav_icon/auth/revoke.gif');
insert into CP_MENU_RESOURCE (ID, CODE, RESOURCE_NAME, VALID, DESCRIPTION, LINKPATH, DISP_ORDER, BIG_IMAGE, PARENT_RESOURCE_ID, ICON)values (1035, '20010300', '临时授权', 1, null, 'security.userAuthList'||chr(38)||'state=3', 3, null, 1010,  '../images/nav_icon/auth/temp_auth.gif');
insert into CP_MENU_RESOURCE (ID, CODE, RESOURCE_NAME, VALID, DESCRIPTION, LINKPATH, DISP_ORDER, BIG_IMAGE, PARENT_RESOURCE_ID, ICON)values (1036, '20020100', '授予权限', 1, null, 'security.groupAuthList'||chr(38)||'state=1', 0, null, 1011,  '../images/nav_icon/auth/auth.gif');
insert into CP_MENU_RESOURCE (ID, CODE, RESOURCE_NAME, VALID, DESCRIPTION, LINKPATH, DISP_ORDER, BIG_IMAGE, PARENT_RESOURCE_ID, ICON)values (1037, '20020200', '禁止权限', 1, null, 'security.groupAuthList'||chr(38)||'state=2', 1, null, 1011,  '../images/nav_icon/auth/revoke.gif');
insert into CP_MENU_RESOURCE (ID, CODE, RESOURCE_NAME, VALID, DESCRIPTION, LINKPATH, DISP_ORDER, BIG_IMAGE, PARENT_RESOURCE_ID, ICON)values (1078, '20030100', '授予权限', 1, null, 'security.organAuthList'||chr(38)||'state=1', 0, null, 1081,  '../images/nav_icon/auth/auth.gif');
insert into CP_MENU_RESOURCE (ID, CODE, RESOURCE_NAME, VALID, DESCRIPTION, LINKPATH, DISP_ORDER, BIG_IMAGE, PARENT_RESOURCE_ID, ICON)values (1079, '20030200', '禁止权限', 1, null, 'security.organAuthList'||chr(38)||'state=2', 1, null, 1081,  '../images/nav_icon/auth/revoke.gif');
insert into CP_MENU_RESOURCE (ID, CODE, RESOURCE_NAME, VALID, DESCRIPTION, LINKPATH, DISP_ORDER, BIG_IMAGE, PARENT_RESOURCE_ID, ICON)values (1080, '20030300', '委托授权', 1, null, 'security.organAuthList'||chr(38)||'state=3', 2, null, 1081,  '../images/nav_icon/auth/publish.gif');
