...
$(function(){
	$("#uploadify").uploadify({
       ...
       'uploader' : '<%=basePath%>/fundAllowance/batchUpload.action',
       ...
       'onUploadSuccess' : function(file, data, response){
       		$("#fileTable").show();
       		var addHtml = "<a href='<%=basePath%>/fundAllowance/downloadFile.action?fileName="+data+"'>"+data+"</a>";
...
function downloadTemplete(){
	window.location.href='<%=basePath%>/fundAllowance/downloadFile.action?fileName=FundAllowanceImportTemplate.xls';
}
