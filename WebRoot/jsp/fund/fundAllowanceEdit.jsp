...
$(function(){
	...
	$('#line').val('<s:property value="fundAllowance.line"/>');
	$('#contractNo').val('<s:property value="fundAllowance.contractNo"/>');
...
<div class="mb10">
<s:form action="saveEdit" name="fundAllowance" namespace="/fundAllowance" method="post">
<input type="hidden" name="id" value="<s:property value='fundAllowance.id'/>">
...
<input type="hidden" name="createDate" value="<s:property value='fundAllowance.createDate'/>">
		...
		<tbody id="formBody">
			...
			<tr>
				...
				<td class="must" width="35%">
					<input type="text" name="projectName" class="input_large" readonly="readonly" value="<s:property value='fundAllowance.projectName'/>" maxlength="200" style="width: 320px;border:0px;"/>
					<!-- &nbsp;&nbsp;* -->
				</td>
				<td class="t_r lableTd" width="15%">项目批文号(自动带入)</td>
				<td width="35%">
					<input type="text" id="" name="dispatchNo" class="input_large" readonly="readonly" style="border:0px;" maxlength="200" value="<s:property value='fundAllowance.dispatchNo'/>"/>					
				</td>				
			</tr>
			<tr>
				<td class="t_r lableTd">合同自有编号</td>
				<td class="must" id="contracts_setting_td">
					<select name="contractNo" id="contractNo" onchange="onSelContract(this)">
						<option value="">---请选择---</option>
						<s:iterator id="contract" value="#request.contracts">
							<option contractId="<s:property value="#contract.id"/>" contractName="<s:property value="#contract.contractName"/>"><s:property value="#contract.contractNo"/></option>
						</s:iterator>
					</select>&nbsp;&nbsp;*
				</td>
				<td class="t_r lableTd">合同名称(自动带入)</td>
				<td>
					<input type="text" name="contractName" class="input_large" readonly="readonly" value="<s:property value='fundAllowance.contractName'/>" style="width: 350px;border:0px;" maxlength="200"/>
				</td>				
			</tr>			
			<tr>
				...
				<td>
					<input type="hidden" name="line" value="<s:property value='fundAllowance.line'/>"/>
					<s:property value='fundAllowance.line'/>
<%-- 				<select name="line" id="line">
			...
			<tr>
				...
				<td colspan="3" class="must"><input type="text" id="" name="money" value="<s:property value='fundAllowance.money'/>" class="input_large" maxlength="20"/>&nbsp;&nbsp;*</td>			
			</tr>
		</tbody>
		<tr class="tfoot">
