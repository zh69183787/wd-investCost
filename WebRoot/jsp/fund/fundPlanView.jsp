...
<div class="mb10">
<s:form action="saveAdd" name="fundPlan" namespace="/fundPlan" method="post">
	<table width="100%" class="table_1">
		...
		<tbody id="formBody">
			...
			<tr>
				...
				<td colspan="3" >
					<s:property value='fundPlan.dispatchNo'/>	
				</td>
			</tr>
			<tr>
				<td class="t_r lableTd" style="width: 15%;">计划年度</td>
				<td style="width: 35%;"><s:property value='fundPlan.year'/></td>
				<td class="t_r lableTd" style="width: 15%;">线路</td>
				<td style="width: 35%;"><s:property value='fundPlan.line'/></td>
			</tr>
			<tr>
				<td class="t_r lableTd">用款计划(万元)</td>
				<td colspan="3">
					<s:property value='fundPlan.money'/>
				</td>
			</tr>
		</tbody>
		<tr class="tfoot">
