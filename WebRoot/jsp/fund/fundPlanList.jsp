...
function checkSonWindow(){
	if(sonWindow!=null && sonWindow.closed==true){
		window.location.href = "findFundPlanByPage.action";
...
<body>
	<div class="main"><!--Ctrl-->
		...
		<div class="filter">
			...
			<s:form action="findFundPlanByPage" name="fundPlan" namespace="/fundPlan" method="post" id="form">
			...
			<input type="hidden" name="pageNo" id="pageNo" value="<s:property value='#request.page.currentPageNo'/>"/>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr id="search">
						<td class="t_r" style="white-space:nowrap">计划年度</td>
						...
						<td style="white-space:nowrap">
							<input type="text" name="dispatchNo" id="textfield" class="input_large" value="<s:property value='fundPlan.dispatchNo'/>" >
						</td>
						<td class="t_r" style="white-space:nowrap">线路</td>
						<td style="white-space:nowrap">
							<input type="text" name="line" id="textfield" class="input_large" value="<s:property value='fundPlan.line'/>" >
						</td>					
					</tr>
					<tr>
		...
		<table width="100%" class="table_1">
			<thead>
				<th colspan="8">&nbsp;&nbsp;资金计划列表</th>
			</thead>
			<tbody>
				<tr class="tit">
					<td width="5%;" style="white-space:nowrap">序号</td>
					<td width="10%;" class="t_r" style="white-space:nowrap">计划年度</td>
					<td width="20%;" class="t_r" style="white-space:nowrap">项目批文号</td>
					<td width="20%;" class="t_r" style="white-space:nowrap">线路</td>
					<td width="15%;" class="t_r" style="white-space:nowrap">用款计划(万元)</td>
					<td width="10%;" class="t_r" colspan="3" style="white-space:nowrap">操作</td>
				</tr>
				<s:iterator value="#request.page.result" id="fundPlan" status="st">
					<tr>
						<td class="t_c" style="word-break:break-all"><s:property value="#request.page.start+#st.index"/></td>
						<td class="t_c" style="word-break:break-all"><s:property value="#fundPlan.year"/></td>
						<td class="t_c" style="word-break:break-all"><s:property value="#fundPlan.dispatchNo"/></td>
						<td class="t_c" style="word-break:break-all"><s:property value="#fundPlan.line"/></td>
						<td class="t_c" style="word-break:break-all"><s:property value="#fundPlan.money"/></td>
						<td class="t_c">
							<a href="showView.action?id=<s:property value="#fundPlan.id"/>" style="float:inline;" target="_blank">查看</a>
						</td>
						<td class="t_c">
							<a href="javascript:void(0);" onclick="showEditPage('<s:property value="#fundPlan.id"/>');" style="float:inline;">编辑</a>
						</td>
						<td class="t_c">
							<a href="#" style="float:inline;" onclick="deleteData('<s:property value="#fundPlan.id"/>');">删除</a>
						</td>
					</tr>
