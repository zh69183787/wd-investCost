	...
	<table width="100%" class="table_1">
		...
		<tbody id="formBody">
			...
			<div>
					...
					<input type="hidden" value="<s:property value='#request.contractChangeItem.removed'/>" name="removed"/>
					<input type="hidden" value="<s:property value='#request.contractChangeItem.createDate'/>" name="removed"/>
