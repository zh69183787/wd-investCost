...
function clearSearch(){
	$("input[name='contractAttribute']").val("");
	$("input[name='contractAttributeId']").val("");
			...
			<div class="tabs_2 nwarp">
	        	<ul class="nwarp">
	        		<s:if test="#request.showAll=='hide'">
	        			<li><a href="findContractByPage.action"><span>全部</span></a></li>
	        		</s:if>
	        		<s:else>
						<s:if test="#request.cType==1">	   
							<li><a href="findContractByPage.action"><span>全部</span></a></li>
							<li class="selected"><a href="findContractByPage.action?cType=1"><span>建设类</span></a></li>
			           		<li><a href="findContractByPage.action?cType=2"><span>运维类</span></a></li>
			           		<li><a href="findContractByPage.action?cType=3"><span>其他类</span></a></li>
						</s:if> 
						<s:elseif test="#request.cType==2">
							<li><a href="findContractByPage.action"><span>全部</span></a></li>
							<li><a href="findContractByPage.action?cType=1"><span>建设类</span></a></li>
			           		<li class="selected"><a href="findContractByPage.action?cType=2"><span>运维类</span></a></li>
			           		<li><a href="findContractByPage.action?cType=3"><span>其他类</span></a></li>
						</s:elseif>    		
						<s:elseif test="#request.cType==3">
							...
							<li><a href="findContractByPage.action?cType=1"><span>建设类</span></a></li>
			           		<li><a href="findContractByPage.action?cType=2"><span>运维类</span></a></li>
			           		<li class="selected"><a href="findContractByPage.action?cType=3"><span>其他类</span></a></li>
						</s:elseif>
		        		<s:else>
		        			<li class="selected"><a href="findContractByPage.action"><span>全部</span></a></li>
							<li><a href="findContractByPage.action?cType=1"><span>建设类</span></a></li>
			           		<li><a href="findContractByPage.action?cType=2"><span>运维类</span></a></li>
			           		<li><a href="findContractByPage.action?cType=3"><span>其他类</span></a></li>
		        		</s:else>	        			
					...
					<input type="hidden" name="companyType" id="companyType" value="<s:property value='#request.companyType'/>">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td class="t_r" style="white-space:nowrap">合同属性(建设类)</td>
								<td>
									<input type="text"   name="contractAttribute" id="contractAttribute" value="<s:property value='contract.contractAttribute'/>"/>
