		...
		<div class="pt45">
	        ...
	        <div class="filter" id="quickSearch">
	        	<div class="query p8" id="searchArea" style="display: none;">
					<s:form action="findByCondition" name="contract" namespace="/contract" method="post" id="form">
	        	...
	        	<div class="fn clearfix">
					<span style="float: right;">
						...
						<s:if test="#request.isShow=='show'">
							<input type="button" value="KPI销缺" onclick="location.href='<%=basePath%>/contract/kpiClearList.action?contractType=2,&condition=condition5&companyId='" style="float:right;margin-right: 10px;"/>
						</s:if>
					</span>
				</div>
