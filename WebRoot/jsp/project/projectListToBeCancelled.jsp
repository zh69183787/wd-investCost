...
//页面缩略显示
$(function(){
	$("select[name=projectState]").val("<s:property value='project.projectState'/>");
	...
	<div class="pt45">
		<div class="filter">
			<div class="query p8" id="searchArea">
				<s:form action="findProjectByPageToBeCancelled" name="project" namespace="/project" method="post" id="form">
				...
				<input type="hidden" name="pType" id="pType" value="<s:property value="#request.pType"/>"/>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr id="search1">
							...
							<td class="t_r" style="white-space:nowrap">项目状态</td>
							<td style="white-space:nowrap">
		...
		<table width="100%" class="table_1">
			<thead>
				<th colspan="6">&nbsp;&nbsp;项目列表</th>
			</thead>
			<tbody>
				<tr class="tit">
					<td width="5%;" style="white-space:nowrap;">序号</td>
					<td width="20%;" class="t_r" style="white-space:nowrap;">立项批文号</td>
					<td width="20%;"  class="t_r" style="white-space:nowrap;">项目名称</td>
					<td width="15%;"  class="t_r" style="white-space:nowrap;">批复概算(万元)</td>
					<td width="15%;" class="t_r" style="white-space:nowrap;">竣工决算价(万元)</td>
				...
				<s:iterator value="#request.page.result" id="project" status="st">
					<tr>
						<td class="t_c" style="white-space: nowrap;">
							<s:property value="#st.index+#request.page.start+1"/>
						</td>
                        <td class="t_c" style="white-space: nowrap;" title="<s:property value="#project.dispatchNo"/>">
                        	<span id="limitLength1"><s:property value="#project.dispatchNo"/></span>
                        </td>
                        <td class="t_c" style="white-space: nowrap;" title="<s:property value="#project.projectName"/>">
                        	<span id="limitLength2"><s:property value="#project.projectName"/></span>
                        </td>
                        <td class="t_c" style="white-space: nowrap;"><s:property value="#project.projectBudgetAll"/></td>
                        <td class="t_c" style="white-space: nowrap;"><s:property value="#project.settlementPrice"/></td>
						<td class="t_c" style="white-space: nowrap;">
			...
			<tr class="tfoot">
			      ...
			      <s:else>
			      	<span class="fl">
				      	<s:property value="#request.page.totalSize"/>条记录，当前显示<s:property value="#request.page.start+1"/> -
