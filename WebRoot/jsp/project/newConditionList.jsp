	...
	<div class="pt45">
		<div class="filter">
			<div class="query p8" id="searchArea" style="display:none;">
				<s:form action="findByNewCondition" name="project" namespace="/project" method="post" id="form">
				...
				<input type="hidden" name="projectType" id="contractType" value="<s:property value='#request.projectType'/>"/>
