	...
	<div class="pt45">
		<div class="tabs_2 nwarp" >
       		<ul>
       			<s:if test="#request.pType==null || #request.pType==''">
       				<li class="selected"><a href="findProjectByPage.action?nomodify=<s:property value='#request.nomodify'/>"><span>全部</span></a></li>
       				<li><a href="findProjectByPage.action?pType=0&nomodify=<s:property value='#request.nomodify'/>"><span>内部项目</span></a></li>
	           		<li><a href="findProjectByPage.action?pType=1&nomodify=<s:property value='#request.nomodify'/>"><span>外部项目</span></a></li>
	           		<li><a href="findProjectByPage.action?pType=5&nomodify=<s:property value='#request.nomodify'/>"><span>其他项目</span></a></li>
       			</s:if>
       			<s:elseif test="#request.pType==1">
       				<li><a href="findProjectByPage.action?nomodify=<s:property value='#request.nomodify'/>"><span>全部</span></a></li>
       				<li><a href="findProjectByPage.action?pType=0&nomodify=<s:property value='#request.nomodify'/>"><span>内部项目</span></a></li>
	           		<li class="selected"><a href="findProjectByPage.action?pType=1&nomodify=<s:property value='#request.nomodify'/>"><span>外部项目</span></a></li>
	           		<li><a href="findProjectByPage.action?pType=5&nomodify=<s:property value='#request.nomodify'/>"><span>其他项目</span></a></li>
       			</s:elseif>
       			<s:elseif test="#request.pType==0">
       				<li><a href="findProjectByPage.action?nomodify=<s:property value='#request.nomodify'/>"><span>全部</span></a></li>
					<li class="selected"><a href="findProjectByPage.action?pType=0&nomodify=<s:property value='#request.nomodify'/>"><span>内部项目</span></a></li>
	           		<li><a href="findProjectByPage.action?pType=1&nomodify=<s:property value='#request.nomodify'/>"><span>外部项目</span></a></li>
	           		<li><a href="findProjectByPage.action?pType=5&nomodify=<s:property value='#request.nomodify'/>"><span>其他项目</span></a></li>
       			</s:elseif>
       			<s:else>
					...
					<li><a href="findProjectByPage.action?pType=0&nomodify=<s:property value='#request.nomodify'/>"><span>内部项目</span></a></li>
	           		<li><a href="findProjectByPage.action?pType=1&nomodify=<s:property value='#request.nomodify'/>"><span>外部项目</span></a></li>
	           		<li class="selected"><a href="findProjectByPage.action?pType=5&nomodify=<s:property value='#request.nomodify'/>"><span>其他项目</span></a></li>
       			</s:else>
           </ul>
       </div>
		...
		<div class="filter">
				...
				<div class="p8 stat_3">
                	<dl class="clearfix">
                		<s:if test="#request.pType==0">
	                        ...
	                        <dd >
	                            <ul>
	                            	<s:if test="#request.ygCompany[2]==project.projectAdddeptId">
	                            		<li class="selected"><a href="#" onclick="queryByCompany('0','<s:property value="#request.ygCompany[2]"/>');"><s:property value="#request.ygCompany[0]"/>(<span><s:property value="#request.ygCompany[1]"/></span>)</a></li>
	                            	</s:if>
	                            	<s:else>
	                                	<li><a href="#" onclick="queryByCompany('0','<s:property value="#request.ygCompany[2]"/>');"><s:property value="#request.ygCompany[0]"/>(<span><s:property value="#request.ygCompany[1]"/></span>)</a></li>
	                                </s:else>
	                            
	                            
	                            	<s:if test="#request.eduCompany[2]==project.projectAdddeptId">
	                            		<li class="selected"><a href="#" onclick="queryByCompany('0','<s:property value="#request.eduCompany[2]"/>');"><s:property value="#request.eduCompany[0]"/>(<span><s:property value="#request.eduCompany[1]"/></span>)</a></li>
	                            	</s:if>
	                            	<s:else>
	                                	<li><a href="#" onclick="queryByCompany('0','<s:property value="#request.eduCompany[2]"/>');"><s:property value="#request.eduCompany[0]"/>(<span><s:property value="#request.eduCompany[1]"/></span>)</a></li>
	                                </s:else>
			...
			<div class="query p8" id="searchArea">
				<s:form action="findProjectByPage" name="project" namespace="/project" method="post" id="form">
