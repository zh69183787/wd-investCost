...
$(function(){
	...
	$trList.each(function(index,object){
		...
		if(index!=$trList.length-1){
			...
			var h = "<a href='<%=basePath%>/project/findProjectByPage.action?nomodify=viewOnly&projectMoneysource="+$.trim($(this).find("td:eq(1)").text())+"&approvalDate="+$("#year").val()+"' target='_blank'>"+rowTotal.toFixed(4)+"</a>";
			$(this).find("td:eq(8)").html(h);
		}
	});
	//<a href="project/findProjectByPage.action?professionalType=1">
	totalAll = type1All + type2All + type3All 
				+ type4All + type5All + type6All;
	$totalTr.find("td:eq(2)").html("<a href='<%=basePath%>/project/findProjectByPage.action?professionalType=1&nomodify=viewOnly&approvalDate="+$("#year").val()+"' target='_blank'>"+type1All.toFixed(4)+"</a>");
	$totalTr.find("td:eq(3)").html("<a href='<%=basePath%>/project/findProjectByPage.action?professionalType=2&nomodify=viewOnly&approvalDate="+$("#year").val()+"' target='_blank'>"+type2All.toFixed(4)+"</a>");
	$totalTr.find("td:eq(4)").html("<a href='<%=basePath%>/project/findProjectByPage.action?professionalType=3&nomodify=viewOnly&approvalDate="+$("#year").val()+"' target='_blank'>"+type3All.toFixed(4)+"</a>");
	$totalTr.find("td:eq(5)").html("<a href='<%=basePath%>/project/findProjectByPage.action?professionalType=4&nomodify=viewOnly&approvalDate="+$("#year").val()+"' target='_blank'>"+type4All.toFixed(4)+"</a>");
	$totalTr.find("td:eq(6)").html("<a href='<%=basePath%>/project/findProjectByPage.action?professionalType=5&nomodify=viewOnly&approvalDate="+$("#year").val()+"' target='_blank'>"+type5All.toFixed(4)+"</a>");
	$totalTr.find("td:eq(7)").html("<a href='<%=basePath%>/project/findProjectByPage.action?professionalType=6&nomodify=viewOnly&approvalDate="+$("#year").val()+"' target='_blank'>"+type6All.toFixed(4)+"</a>");
...
function drawChart(){
	...
	$.ajax({
			type : 'post',
			url : '<%=basePath%>/dwProject/findAllData.action?random='+Math.random(),
			dataType:'json',
			cache : false,
			data:{
				year : $("#year").val()
						...
						<tr id="search1">
							...
							<td style="white-space:nowrap">
								...
								<s:if test="type == 1 || type == null">
										...
										<option value="1" selected="selected">报表1—年度线路分专业立项情况统计表</option>
							...
							<td style="white-space:nowrap" >
								<SELECT name="year" id="year">
									<s:if test="#request.year=='2012'">
										<option value="2012" selected="selected">2012</option>
										<option value="2013">2013</option>
										<option value="2014">2014</option>
									</s:if>
									<s:elseif test="#request.year=='2013'">
										<option value="2012">2012</option>
										<option value="2013" selected="selected">2013</option>
										<option value="2014">2014</option>
									</s:elseif>
									<s:elseif test="#request.year=='2014'">
										<option value="2012">2012</option>
										<option value="2013">2013</option>
								...
								&nbsp;&nbsp;&nbsp;<input type="button" name="sreach" value="查询" onclick="showList();"/>&nbsp
...
<!--Tabs_2 End-->
<div id="h"><s:property value="#request.sDate.substring(0,4)"/>年度线路分专业立项情况统计表</div>
<div id="h1">单位：万元</div>
<div class="mb10">
		...
		<tbody>
			...
			<s:iterator value="#request.list" id="list" status="st">
				<tr>
					...
					<td class="t_r" id="type1"><a href="<%=basePath%>/project/findProjectByPage.action?professionalType=1&nomodify=viewOnly&projectMoneysource=<s:property value="#list.lineName"/>&approvalDate=<s:property value="#request.year"/>" target="_blank"><s:property value="%{getFormattedMoney(#list.type1)}"/></a></td>
					<td class="t_r" id="type2"><a href="<%=basePath%>/project/findProjectByPage.action?professionalType=2&nomodify=viewOnly&projectMoneysource=<s:property value="#list.lineName"/>&approvalDate=<s:property value="#request.year"/>" target="_blank"><s:property value="%{getFormattedMoney(#list.type2)}"/></a></td>
					<td class="t_r" id="type3"><a href="<%=basePath%>/project/findProjectByPage.action?professionalType=3&nomodify=viewOnly&projectMoneysource=<s:property value="#list.lineName"/>&approvalDate=<s:property value="#request.year"/>" target="_blank"><s:property value="%{getFormattedMoney(#list.type3)}"/></a></td>
					<td class="t_r" id="type4"><a href="<%=basePath%>/project/findProjectByPage.action?professionalType=4&nomodify=viewOnly&projectMoneysource=<s:property value="#list.lineName"/>&approvalDate=<s:property value="#request.year"/>" target="_blank"><s:property value="%{getFormattedMoney(#list.type4)}"/></a></td>
					<td class="t_r" id="type5"><a href="<%=basePath%>/project/findProjectByPage.action?professionalType=5&nomodify=viewOnly&projectMoneysource=<s:property value="#list.lineName"/>&approvalDate=<s:property value="#request.year"/>" target="_blank"><s:property value="%{getFormattedMoney(#list.type5)}"/></a></td>
					<td class="t_r" id="type6"><a href="<%=basePath%>/project/findProjectByPage.action?professionalType=6&nomodify=viewOnly&projectMoneysource=<s:property value="#list.lineName"/>&approvalDate=<s:property value="#request.year"/>" target="_blank"><s:property value="%{getFormattedMoney(#list.type6)}"/></a></td>
