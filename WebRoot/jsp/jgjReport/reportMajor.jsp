...
function refresh(){
	window.location.href='showReportMajor.action?year='+$('#year').val()+'&type='+$('#type').val();
	showReportName();
}
	...
	<div class="ctrl clearfix">
		...
		<div class="posi fl">
			<ul>
				...
				<li class="fin">年度资金计划完成情况表(项目详表)</li>
			</ul>
		</div>
							...
							<td style="white-space:nowrap" width="15%;">
								<select id="reportType" name="reportType" class="input_slarge" class="input_large" onchange="changeReport(this.value);">
										<s:if test="type == 4 || type == null">
											...
											<option value="23" selected="selected">报表2.3,2.4年度资金计划完成情况表(分专业汇总)</option>
...
<div align="center" id = "h">
		<s:if test="#request.type==3">
			申通地铁集团xxxx年轨道交通运营设施设备大修项目资金计划完成情况表(大修，分专业汇总）
		</s:if>
		<s:elseif test="#request.type==2">
			申通地铁集团xxxx年轨道交通运营设施设备更新改造项目资金计划完成情况表(更新改造，分专业汇总)
		</s:elseif>
		<s:else>
			申通地铁集团xxxx年轨道交通运营设施设备大修项目资金计划完成情况表(大修，分专业汇总）
		</s:else>
	...
	<table width="100%"  class="table_1">
		<thead style="background: white;">
			<tr class="nwarp" >
                ...
                <td class="t_c" colspan="4" style="" width="15%;">车辆</td>
                <td class="t_c" colspan="4" style="" width="15%;">供电</td>
                <td class="t_c" colspan="4" style="" width="15%;">通号</td>
                <td class="t_c" colspan="4" style="" width="15%;">工务</td>
                <td class="t_c" colspan="4" style="" width="15%;">车站机电</td>
                <td class="t_c" colspan="4" style="" width="15%;">段场</td>
                <td class="t_c" colspan="4" style="" width="15%;">其他</td>
                <td class="t_c" colspan="4" style="" width="15%;">合计</td>
            </tr>
            <tr class="nwarp" >
                <td class="t_c" colspan="2" >计划用款</td>
                <td class="t_c" colspan="2" >实际用款</td>
                <td class="t_c" colspan="2" >计划用款</td>
                <td class="t_c" colspan="2" >实际用款</td>
                <td class="t_c" colspan="2" >计划用款</td>
                <td class="t_c" colspan="2" >实际用款</td>
		...
		<tbody id="dataArea">
			<s:iterator id="major" value="#request.result" status="st">
				<tr>
	                ...
	                <td class="t_r"><s:property value="#major.carActualCount"/></td>
	                <td class="t_r"><s:property value="#major.carActualGov"/></td>
	                <td class="t_r"><s:property value="#major.elePlanCount"/></td>
	                <td class="t_r"><s:property value="#major.elePlanGov"/></td>
	                <td class="t_r"><s:property value="#major.eleActualCount"/></td>
	                <td class="t_r"><s:property value="#major.eleActualGov"/></td>
	                <td class="t_r"><s:property value="#major.numPlanCount"/></td>
	                <td class="t_r"><s:property value="#major.numPlanGov"/></td>
	                <td class="t_r"><s:property value="#major.numActualCount"/></td>
	                <td class="t_r"><s:property value="#major.numActualGov"/></td>
	                <td class="t_r"><s:property value="#major.workPlanCount"/></td>
	                <td class="t_r"><s:property value="#major.workPlanGov"/></td>
	                <td class="t_r"><s:property value="#major.workActualCount"/></td>
	                <td class="t_r"><s:property value="#major.workActualGov"/></td>
	                <td class="t_r"><s:property value="#major.stationPlanCount"/></td>
	                <td class="t_r"><s:property value="#major.stationPlanGov"/></td>
	                <td class="t_r"><s:property value="#major.stationActualCount"/></td>
	                <td class="t_r"><s:property value="#major.stationActualGov"/></td>
	                <td class="t_r"><s:property value="#major.basePlanCount"/></td>
	                <td class="t_r"><s:property value="#major.basePlanGov"/></td>
	                <td class="t_r"><s:property value="#major.baseActualCount"/></td>
	                <td class="t_r"><s:property value="#major.baseActualGov"/></td>
	                <td class="t_r"><s:property value="#major.otherPlanCount"/></td>
	                <td class="t_r"><s:property value="#major.otherPlanGov"/></td>
	                <td class="t_r"><s:property value="#major.otherActualCount"/></td>
	                <td class="t_r"><s:property value="#major.otherActualGov"/></td>
	                <td class="t_r"><s:property value="#major.allPlanCount"/></td>
	                <td class="t_r"><s:property value="#major.allPlanGov"/></td>
	                <td class="t_r"><s:property value="#major.allActualCount"/></td>
	                <td class="t_r"><s:property value="#major.allActualGov"/></td>
	            </tr>
			</s:iterator>
				<tr>
