...
<head>
<meta charset="utf-8" />
<title>轨道交通运营设施设备大修和更新改造项目资金计划情况完成表</title>
...
function refresh(){
	window.location.href='showReportMajorSeason.action?year='+$('#year').val()+'&season='+$('#season').val();
}
...
function showReportName(){
	var html = '申通地铁集团'+$('#year').val()+'年第'+$('#season').val()+'季度轨道交通运营设施设备大修和更新改造项目资金计划完成情况季度表(汇总表）';
	$('#h').html(html);
}
	...
	<div class="ctrl clearfix">
		...
		<div class="posi fl">
			<ul>
				...
				<li class="fin">季度资金计划完成情况表(汇总表）</li>
			</ul>
		</div>
							...
							<td style="white-space:nowrap" width="15%;">
								<select id="reportType" name="reportType" class="input_slarge" class="input_large" onchange="changeReport(this.value);">
										<s:if test="type == 4 || type == null">
											...
											<option value="31" selected="selected">报表3.1汇总表季度总结</option>
...
<div align="center" id = "h">
	申通地铁集团年季度轨道交通运营设施设备大修项目资金计划完成情况表(专业汇总）
</div>
<!--Tabs_2 End-->
	...
	<table width="100%"  class="table_1">
		<thead style="background: white;">
			<tr class="nwarp" >
                ...
                <td class="t_c" colspan="4" style="" width="15%;">大修</td>
                <td class="t_c" colspan="4" style="" width="15%;">更新改造</td>
                <td class="t_c" colspan="4" style="" width="15%;">总计</td>
            </tr>
            <tr class="nwarp" >
		...
		<tbody id="dataArea">
			<s:iterator id="major" value="#request.result" status="st">
				<tr>
	                ...
	                <td class="t_r"><s:property value="#major.overhaulActualCount"/></td>
	                <td class="t_r"><s:property value="#major.overhaulActualGov"/></td>
	                <td class="t_r"><s:property value="#major.updatePlanCount"/></td>
	                <td class="t_r"><s:property value="#major.updatePlanGov"/></td>
	                <td class="t_r"><s:property value="#major.updateActualCount"/></td>
	                <td class="t_r"><s:property value="#major.updateActualGov"/></td>
